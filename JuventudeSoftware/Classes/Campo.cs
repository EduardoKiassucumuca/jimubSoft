...
namespace WindowsFormsApplication1.Classes
{
    public class Campo
    {
       ...
       // public string exito;
        ...
        private String comissaoEncarregue, tema, objectivo, orador,estado_actividade,local_actividade, data_actividade, hora, mes_actividade,obs;
        ...
        public void setMesActividade(String mes)
        {
            this.mes_actividade = mes;
        }
        ...
        public void setOBSactividade(String obs)
        {
            this.obs = obs;
        }

        public String getOBSActividade()
        {
            return this.obs;
        }
